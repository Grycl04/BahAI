...
def recommendations(req: https_fn.Request) -> https_fn.Response:
    ...
    This function handles ALL recommendation routes based on firebase.json rewrites:
    - /recommendations
    - /recommendations/**
    - /api/**
    """
    ...
    try:
        ...
        if req.method == "GET":
            ...
            return https_fn.Response(
                json.dumps({"error": "Method not allowed", "allowed_methods": ["GET", "POST", "OPTIONS"]}),
                status=405,
                headers={"Content-Type": "application/json", "Access-Control-Allow-Origin": "*"}
            )
        ...
        if not user_id:
            return https_fn.Response(
                json.dumps({
                    ...
                    "usage_examples": {
                        "GET": "/recommendations?user_id=USER_ID&count=10",
                        "POST": "/recommendations with JSON body: {\"user_id\": \"USER_ID\", \"count\": 10}"
                    }
                }),
                status=400,
                headers={"Content-Type": "application/json", "Access-Control-Allow-Origin": "*"}
        ...
        try:
            ...
            logging.warning(f"Could not fetch user data for {user_id}: {str(e)}")
...
def health(req: https_fn.Request) -> https_fn.Response:
    ...
    health_status = {
        ...
        "endpoints": {
            ...
            "post_recommendations": "POST /recommendations with JSON body",
...
def generate_recommendations(user_id: str, user_data: Dict = None, 
    ...
    dummy_items = [
        {"item_id": "item_001", "score": 0.95, "title": "Premium Headphones", "category": "electronics", "price": 299.99},
        {"item_id": "item_002", "score": 0.88, "title": "Smart Watch", "category": "electronics", "price": 249.99},
        {"item_id": "item_003", "score": 0.82, "title": "Laptop Stand", "category": "accessories", "price": 89.99},
        {"item_id": "item_004", "score": 0.78, "title": "Wireless Mouse", "category": "accessories", "price": 59.99},
        {"item_id": "item_005", "score": 0.75, "title": "USB-C Hub", "category": "accessories", "price": 79.99},
        {"item_id": "item_006", "score": 0.72, "title": "Backpack", "category": "fashion", "price": 129.99},
        {"item_id": "item_007", "score": 0.68, "title": "Water Bottle", "category": "lifestyle", "price": 34.99},
        {"item_id": "item_008", "score": 0.65, "title": "Notebook", "category": "stationery", "price": 24.99},
        {"item_id": "item_009", "score": 0.62, "title": "Desk Lamp", "category": "home", "price": 149.99},
        {"item_id": "item_010", "score": 0.60, "title": "Phone Case", "category": "accessories", "price": 39.99}
    ]
    
    # If item_id is provided, simulate item-based recommendations
    if item_id:
        return [
            {"item_id": f"similar_to_{item_id}_{i}", "score": 0.9 - (i * 0.1), 
